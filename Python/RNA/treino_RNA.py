...
for epoch in range(50):  # loop over the dataset multiple times
    ...
    for i in range(len(entrada)):
        ...
        outputs = model(entrada[i].unsqueeze(0).unsqueeze(0))
    ...
    grafico_treino.append(running_loss/len(entrada))
    ...
    grafico_validacao.append(running_loss/len(entrada_validacao))
...
plt.subplot(2,1,1)
plt.plot(grafico_x, grafico_treino)

plt.subplot(2,1,2)
plt.plot(grafico_x, grafico_validacao)
